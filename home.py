...
<div class="footer">
  ...
  <div class="footer-links">
    ...
    <a class="footer-link" href="#">Indian Market</a>
    <a class="footer-link" href="#">US Market</a>
  </div>
  <div class="footer-disclaimer">
    ...
    Data sourced from NSE India / Alpha Vantage where available, with yfinance fallback only when primary feeds fail.
  </div>
</div>
""", unsafe_allow_html=True)
